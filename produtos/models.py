...
# --- AULA 18 & 26: DEFINIÇÃO DO MODELO PRODUTO ---
class Produto(models.Model):  # Aula 18: Criação da entidade Produto 
    ...
    marca = models.CharField(max_length=50, default="Genérica")  # Aula 26: Campo de marca obrigatório
    ...
    estoque = models.IntegerField(default=0)  # Aula 18 & 26: Campo inteiro para quantidade em estoque 
